...
Source0  : https://download.gnome.org/sources/graphene/1.10/graphene-1.10.2.tar.xz
...
%prep
%setup -q -n graphene-1.10.2
cd %{_builddir}/graphene-1.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600353752
...
cp %{_builddir}/graphene-1.10.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/graphene/53ca621a56a9ded7d6ba2f3e608a43515875783b
cp %{_builddir}/graphene-1.10.2/subprojects/mutest/LICENSE.txt %{buildroot}/usr/share/package-licenses/graphene/13869509cd8e339104f92084c841c24a72ca2034
cp %{_builddir}/graphene-1.10.2/subprojects/mutest/docs/LICENSE.markdeep.txt %{buildroot}/usr/share/package-licenses/graphene/25997556cbd0a4d064057d267c81c8d8b60e7be4
...
/usr/lib64/libgraphene-1.0.so.0.1000.2
